...
class Receta(models.Model):
	...
	class Meta:
		ordering = ["-created_at"]
		db_table = "api_receta"
		constraints = [models.CheckConstraint(condition=models.Q(tiempo_preparacion__gt=0), name="receta_tiempo_positivo")]
...
class RecetaIngrediente(models.Model):
	...
	class Meta:
		db_table = "api_recetaingrediente"
		constraints = [
...
class Favorito(models.Model):
	...
	class Meta:
		db_table = "api_favorito"
		constraints = [models.UniqueConstraint(fields=["usuario", "receta"], name="favorito_usuario_receta_unica")]
